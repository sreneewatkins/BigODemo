/* This class starts the execute time clock before and after ea test.
    It saves the input size and execution time in a file to later draw them in a graph.
    It also defines input size array to be used in a parameter tests for these 4 algorithms
 */
